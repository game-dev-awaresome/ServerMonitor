...
namespace System.DataCenter
{
    ...
    /// SQL 处理方法
    /// </summary>
    public class MSSQLOperate : DataOperate, IMSSQLOperate
    {
        #region 构造/析构函数
        /// <summary>
        /// 构造函数
        ...
        public MSSQLOperate(string strConnect)
        {
        ...
        {
            string Str_Pro = MSSQL_SqlConstant.Str_GetDatabase;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_Structure;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetTableList;
            this.ExecuteQuery(Str_Sql);
            this.GetResult(RecordStyle.DATASET);
        }
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetViewList;
            this.ExecuteQuery(Str_Sql);
            this.GetResult(RecordStyle.DATASET);
        }
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetProcList;
            this.ExecuteQuery(Str_Sql);
            this.GetResult(RecordStyle.DATASET);
        }
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetFunctionList;
            this.ExecuteQuery(Str_Sql);
            this.GetResult(RecordStyle.DATASET);
        }
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetTable;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetView;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetProc;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetFunction;
        ...
        {
            string Str_Sql = MSSQL_SqlConstant.Str_GetDatatype;
            this.ExecuteQuery(Str_Sql);
            this.GetResult(RecordStyle.DATASET);
        }
